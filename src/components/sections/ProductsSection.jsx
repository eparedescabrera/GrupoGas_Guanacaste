            ...
            return (
              <motion.div key={p.id} variants={staggerItem} className="h-full">
                <Card className="group flex h-full flex-col overflow-hidden p-0">
                  <div className="relative flex h-56 w-full items-end justify-center overflow-hidden border-b border-slate-100 bg-[radial-gradient(ellipse_at_center,_#f8faff_0%,_#eef2fb_55%,_#e4eaf6_100%)] px-4 pb-3 pt-5 sm:h-60">
                    <div
                      className="pointer-events-none absolute inset-x-8 bottom-3 h-3 rounded-[100%] bg-slate-900/10 blur-md"
                      aria-hidden="true"
                    />
                    <span className="absolute left-3 top-3 rounded-full bg-white/95 px-2.5 py-1 text-[10px] font-extrabold tracking-wider text-brand-blue ring-1 ring-slate-200 shadow-soft">
                      {p.capacity}
                    </span>
                    <span className="absolute right-3 top-3 rounded-full bg-brand-green/10 px-2.5 py-1 text-[10px] font-bold text-brand-green ring-1 ring-brand-green/20">
                      {info.usage}
                    </span>
                    <div
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-2 min-h-[52px] text-sm leading-relaxed text-slate-700">
                      {info.description}
                    </p>
                    <Button
                      as="a"
